...
from WyneMusic import YouTube, app
from WyneMusic.utils.decorators.language import language, languageCB
from WyneMusic.utils.formatters import convert_bytes
from WyneMusic.utils.inline.song import song_markup
...
async def song_helper_cb(client, CallbackQuery, _):
    ...
    if stype == "audio":
        ...
        for x in formats_available:
            ...
            try:
                format_id_int = int(format_id)  # Try to convert to integer
            except ValueError:
                format_id_int = None

            if format_id_int not in done:
                continue
...
async def song_download_cb(client, CallbackQuery, _):
    ...
    with yt_dlp.YoutubeDL({
        "quiet": True,
        "cookiefile": "cookies.txt"  # Update this path to your actual cookies.txt location
    }) as ytdl:
        try:
