...
MUST_JOIN = getenv("MUST_JOIN", "WynneProjects")
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "7494727691").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/NyxianNetwork/NyxianMusic",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/WynneProjects"
)  # Example:- https://t.me/AnonymousX888
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/WynneSupports"
)  # Example:- https://t.me/WynneSupports
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/WynneSupports")
...
START_IMG_URL = getenv(
    "START_IMG_URL",
    "https://files.catbox.moe/xq3k1f.jpg",
)
...
if GLOBAL_IMG_URL:
    if GLOBAL_IMG_URL != "https://files.catbox.moe/xq3k1f.jpg":
...
if STATS_IMG_URL:
    if STATS_IMG_URL != "https://files.catbox.moe/xq3k1f.jpg":
...
if TELEGRAM_AUDIO_URL:
    if TELEGRAM_AUDIO_URL != "https://files.catbox.moe/xq3k1f.jpg":
...
if STREAM_IMG_URL:
    if STREAM_IMG_URL != "https://files.catbox.moe/xq3k1f.jpg":
...
if SOUNCLOUD_IMG_URL:
    if SOUNCLOUD_IMG_URL != "https://files.catbox.moe/xq3k1f.jpg":
...
if YOUTUBE_IMG_URL:
    if YOUTUBE_IMG_URL != "https://files.catbox.moe/xq3k1f.jpg":
...
if TELEGRAM_VIDEO_URL:
    if TELEGRAM_VIDEO_URL != "https://files.catbox.moe/xq3k1f.jpg":
